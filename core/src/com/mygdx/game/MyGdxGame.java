...
public class MyGdxGame extends ApplicationAdapter {
    ...
    boolean gameover;
    Texture vidas = new Texture("nimbus_1.png");
    ...
    public void render() {
        ...
        if (jugador.vidas == 3) batch.draw(vidas,1800, 1000);batch.draw(vidas,1700, 1000);batch.draw(vidas,1600, 1000);
        if (jugador.vidas == 2) batch.draw(vidas,1800, 1000);batch.draw(vidas,1700, 1000);
        if (jugador.vidas == 1) batch.draw(vidas,1800, 1000);
